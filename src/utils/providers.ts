...
export const featuredProviders: Provider[] = [
  ...
  },
  {
    ...
    description:
      "Founder of BBB, advanced tools for onchain trading and spiritual leader. Being one of the best and most respected traders, Known for his unique trading methodologies and mental guidance in the space.",
    delay: 0.1,
  },
  {
    name: "MissorAlways",
